void ref_time (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("DEF-files/COIN/PRODUCTION/ref_time.def");
  // Define cuts file
 // analyzer->SetCutFile("DEF-files/COIN/PRODUCTION/CUTS/ref_time.def");  // optional
